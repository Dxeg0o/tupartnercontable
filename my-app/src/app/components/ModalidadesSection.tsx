...
export function ModalidadesSection({ serviceModes }: ModalidadesSectionProps) {
  return (
    <section id="modalidades" className="mt-28 grid gap-16 lg:grid-cols-[1fr_1.15fr]" aria-labelledby="modalidades-heading">
      <div className="relative flex items-center justify-center">
        <div className="relative w-full max-w-[420px]">
          ...
          <div className="absolute -bottom-10 left-6 w-52 rounded-3xl border border-white bg-white/90 p-4 shadow-lg backdrop-blur">
            <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Satisfacción promedio</p>
      ...
      <div className="space-y-10">
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            <h2 id="modalidades-heading" className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            ...
            >
              <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 via-indigo-400 to-sky-400 text-white shadow-lg shadow-indigo-200/70">
                <svg
                  ...
                  className="h-6 w-6"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 6.75h13.5M5.25 12h13.5m-13.5 5.25h9" />
                </svg>
              </div>
