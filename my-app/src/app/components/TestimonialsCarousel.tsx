    ...
    >
      <div className="flex flex-col gap-4 text-center">
        ...
        <div className="space-y-3">
          ...
          <p className="mx-auto max-w-2xl text-base leading-relaxed text-[var(--neutral-gray)]">
      ...
      <div className="relative w-full max-w-4xl">
        <div className="rounded-[2.75rem] border border-[var(--neutral-light)] bg-[var(--neutral-white)]/90 p-10 text-center shadow-2xl shadow-[rgba(53,113,223,0.18)]">
          <div className="flex justify-center">
            <span className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border border-[var(--neutral-light)] bg-[rgba(106,154,250,0.15)]">
              <Image
          ...
          <blockquote className="mt-8 space-y-6">
            <p className="text-lg italic leading-relaxed text-[var(--neutral-carbon)]">
              “{activeTestimonial.quote}”
            </p>
            <footer className="space-y-1">
              <p className="text-base font-semibold text-[var(--neutral-carbon)]">
                {activeTestimonial.author}
              </p>
              <p className="text-sm text-[var(--neutral-gray)]">{activeTestimonial.role}</p>
            </footer>
          </blockquote>
        </div>

        <div className="absolute -bottom-8 left-1/2 flex -translate-x-1/2 items-center gap-4 rounded-full border border-[var(--neutral-light)] bg-[var(--neutral-white)]/90 px-4 py-2 shadow-lg shadow-[rgba(53,113,223,0.15)] backdrop-blur">
          <button
            type="button"
            onClick={() => goTo(activeIndex - 1)}
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[var(--primary-blue)] text-[var(--primary-blue)] transition hover:bg-[rgba(53,113,223,0.2)]"
            ...
            {TESTIMONIALS.map((_, index) => (
              <button
                ...
                className={`h-2.5 rounded-full transition-all ${
                  index === activeIndex
                    ? "w-8 bg-[var(--primary-orange)]"
                    : "w-2.5 bg-[var(--neutral-light)] hover:bg-[var(--secondary-blue)]"
                }`}
