...
export const metadata: Metadata = {
  title: "Asesoría en Recursos Humanos | Tu Partner Contador",
  description:
    "Detalle del servicio de asesoría en recursos humanos de Tu Partner Contador: gestión de remuneraciones, asesoría laboral y planificación tributaria.",
};
